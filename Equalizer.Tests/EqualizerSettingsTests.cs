...
public class EqualizerSettingsTests
{
    ...
    {
        var d = EqualizerSettings.Default;
    ...
    public void BarsCount_OutOfRange_Throws(int bars)
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new EqualizerSettings(bars, 0.5, 0.5, new ColorRgb(0, 0, 0)));
    }
    ...
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new EqualizerSettings(32, v, 0.5, new ColorRgb(0, 0, 0)));
    }
    ...
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            new EqualizerSettings(32, 0.5, v, new ColorRgb(0, 0, 0)));
    }
}
